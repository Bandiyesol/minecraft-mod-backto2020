...
public class QuestManager {
    ...
    static {
        ...
        ALL_QUESTS.add(new Quest(4, "iadd:f_dmb_toast", "더블 모짜렐라 베이컨 토스트 주세요", 2, 56500));
        ALL_QUESTS.add(new Quest(5, "iadd:f_esb_toast", "에그 소시지 베이컨 토스트 주세요", 2, 115000));
        ALL_QUESTS.add(new Quest(6, "iadd:f_psph_toast", "포테이토 고구마 햄토스트 주세요", 2, 240000));
        ALL_QUESTS.add(new Quest(7, "iadd:f_sbh_toast", "핫 베이컨 햄토스트 주세요", 2, 470000));
		
		ALL_QUESTS.add(new Quest(8, "iadd:f_redbean_bun", "팥호빵 주세요", 1, 850));
        ALL_QUESTS.add(new Quest(9, "iadd:f_vegetable_bun", "야채호빵 주세요", 1, 3500));
        ALL_QUESTS.add(new Quest(10, "iadd:f_pizza_bun", "피자호빵 주세요", 1, 8300));
        ALL_QUESTS.add(new Quest(11, "iadd:f_sweetpotato_bun", "고구마호빵 주세요", 2, 18000));
		ALL_QUESTS.add(new Quest(12, "iadd:f_corn_bun", "옥수수호빵 주세요", 2, 38100));
